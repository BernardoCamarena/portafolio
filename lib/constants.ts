export const PROJECTS = [
  ...
  },
  {
    id: 'p2',
    name: 'Helios CRM',
    desc: 'Sistema CRM modular con automatizaciones, integraciones SMTP y panel de analítica en tiempo real.',
  ...
  },
  {
    id: 'p3',
    name: 'Wavefront',
    desc: 'App móvil para músicos: grabación multi-pista, sincronización en la nube y colaboración en tiempo real.',
